...
def CNNmodelv2(xtrain, ytrain):
    ...
    checkpoint = ModelCheckpoint('./models/CNNmodel_v2.hdf5', monitor='val_loss', 
...
hist = CNNmodelv2(xtrain, ytrain) # start training
m = load_model('./models/CNNmodel_v2.hdf5') # load best model
